insert into products(active, description, image_url, name, sku,
    ...
    values (true, 'Third album', 'www.google.com', 'Master of Puppets', 'CD-000001', 15.00, 3, 1, 1),
           ...
           (true, 'Early Metallica', 'www.google.com', 'Riders on the lightning', 'BOOK-000001', 15.00, 2, 1, 3),
           (false, 'Early Iron Maiden', 'www.google.com', '	Troopers of the metal', 'BOOK-000002', 12.00, 0, 3, 3),
           (true, 'Partibrejkersi na EXIT Festivalu 2022', 'www.google.com', 'EXIT 2022', 'DVD-000001', 15.00, 1, 2, 4);